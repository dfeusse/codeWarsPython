'''
Make a program that takes a value (x) and 
returns "Bang" if the number is divisible by 3, 
"Boom" if it is divisible by 5, 
"BangBoom" if it dividible by 3 and 15, and 
"Miss" if it isn't divisible by any of them. Note: Your program should only return one value
